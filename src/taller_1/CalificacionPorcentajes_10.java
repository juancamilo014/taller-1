 ...
 * @author Andres
 */
public class CalificacionPorcentajes_10 extends javax.swing.JFrame {

    /**
     * Creates new form area
     */
    public CalificacionPorcentajes_10() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label2.setText("Calificacion Final");

        label3.setText("Nota1");
        ...
        label5.setText("Nota2");

        label6.setText("Nota3");
    ...
    if(textField1.getText().length()==0 || textField2.getText().length()==0){
        ...
        if (evt.getSource()==button1){
            ...
            double p1 = n1*0.3, p2 = n2*0.3, p3 = n3*0.4;
            r=p1+p2+p3;
            jLabel1.setText(String.valueOf(p1));
            jLabel2.setText(String.valueOf(p2));
            jLabel3.setText(String.valueOf(p3));
            label4.setText(String.valueOf(r)); 
        }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalificacionPorcentajes_10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalificacionPorcentajes_10().setVisible(true);
            }
        });
    }
